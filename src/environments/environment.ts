export const environment = {
  production: false,
  config: {
    apiKey: 'AIzaSyA-w6ueo9NY4uyB7UB_fu12qS0gwqHg0hk',
    authDomain: 'web-shop-fc3e0.firebaseapp.com',
    databaseURL: 'https://web-shop-fc3e0.firebaseio.com',
    projectId: 'web-shop-fc3e0',
